    ...
    var e = {
                      ...
                      switch ((e.prev = e.next)) {
                        ...
                        case 23:
                          return (
                            ...
                            (e.next = 26),
                            f(
                              p.replace("ffmpeg-core.js", "ffmpeg-core.wasm"),
                              "application/wasm"
                            )
                          );
                        case 26:
        ...
        906: (e, t, r) => {
          ...
          e.exports = function () {
            var e =
                ...
                if ("string" == typeof e)
                  if (e.startsWith("  Duration")) {
                    var r = e.split(", ")[0].split(": ")[1],
                      n = S(r);
                    t({ duration: n, ratio: O }), (0 === P || P > n) && (P = n);
                  } else if (e.startsWith("frame") || e.startsWith("size")) {
                    var o = e.split("time=")[1].split(" ")[0],
                      a = S(o);
                    t({ ratio: (O = a / P), time: a });
                  ...
                  regeneratorRuntime.mark(function e() {
                    ...
                    return regeneratorRuntime.wrap(function (e) {
                      for (;;)
                        switch ((e.prev = e.next)) {
                          case 0:
                            if ((L("info", "load ffmpeg-core"), null !== s)) {
                              e.next = 17;
                              break;
                            }
                            return (
                              L("info", "loading ffmpeg-core"),
                              (e.next = 5),
                              w(c)
                            );
                          case 5:
                            return (
                              ...
                              r({
                                ...
                                printErr: function (e) {
                                  return C({ type: "fferr", message: e });
                                },
                                print: function (e) {
                                  return C({ type: "ffout", message: e });
                                },
              ...
              R = function () {
                for (
                  ...
                  t[r] = arguments[r];
                if (
                  (L("info", "run ffmpeg command: ".concat(t.join(" "))),
                  null === s)
                )
                  throw x;
                if (y)
            ...
            return (
              L("info", "use ffmpeg.wasm v".concat(b)),
              {
                setProgress: U,
                setLogger: G,
                setLogging: D,
